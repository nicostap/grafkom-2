...
export function Bar2(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/maps/bar_indoor_try.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[0, 7.753, 0]} scale={1.905}>
        <group position={[-2.651, 0.168, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.6, 0.168, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-2.651, 0.168, 7.045]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.6, 0.168, 7.045]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-2.651, 0.168, 14.089]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.6, 0.168, 14.089]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0.777, -0.229, -2.344]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
